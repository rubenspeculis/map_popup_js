...
function createPie(pieName,pieSize,baseColor,numberOfSlices,percentages,colors){
  ...
  var sizeNum = parseFloat(pieSize.replace("px",""));
	...
	//Pie Background
	var pieForeground = document.createElement("div");
  var foregroundSize = sizeNum-20;
  pieForeground.innerHTML = "<div class='percentageInner'>"+percentages +"%</div>";
  pieForeground.style.width=foregroundSize + "px";
	pieForeground.style.height=foregroundSize + "px";
	pieForeground.style.position="relative";
	pieForeground.style.webkitBorderRadius=foregroundSize + "px";
