...
(function ($) {
  ...
  $(document).ready(function(){
    ...
    var dataLink1 = '<span id="data1-title" title="Downstream Data table for this site">Downstream</span>';
    ...
    if( $('#downstream-data').length != 1){
      var tabTitles = '<div id="tabs">'+ dataLink + graphLink + alertLink + infoLink + csvLink + rssLink + '</div>';
    } else {
      var tabTitles = '<div id="tabs">'+ dataLink + dataLink1 + graphLink + alertLink + infoLink + csvLink + rssLink + '</div>';
    }
  ...
  function hideAllOther(showThis){
    $('#data-table').hide();
    $('#downstream-data').hide();
    $('#data-charts').hide();
    $('#data-alerts').hide();
    $('#data-info').hide();
    $('.data-historical').hide();
    $('#data-table h2').hide();
    $('#downstream-data h2').hide();
    $('#data-charts h2').hide();
    $('#data-alerts h2').hide();
    $('#data-info h2').hide();
    $('.data-historical h2').hide();
